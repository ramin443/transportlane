                           ...
                           child: Row(
                             ...
                             children: [
                               Container(
                                 ...
                                 child: TextField(
                                   controller: searchcontroller.currentstopcontroller,
                                   decoration: InputDecoration(
                                       border: InputBorder.none,
                                       hintStyle: TextStyle(

                                       ),
                                       hintText: "Your current destination"
                     ...
                     child: Row(
                       ...
                       children: [
                         Container(
                           ...
                           child: TextField(
                             controller: searchcontroller.finalstopcontroller,
                             decoration: InputDecoration(
                                 border: InputBorder.none,
                                 hintStyle: TextStyle(
            ...
            ListView.builder(
                ...
                itemBuilder: (context,index){
                  return Column(
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      DestinationWidget(searchcontroller.prevdestlist[index]),
                      Container(
